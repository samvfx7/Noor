...
class PrayerLoggingReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_QUICK_LOG_PRAYER = "com.samvfx7.noor.ACTION_QUICK_LOG_PRAYER"
        const val ACTION_SNOOZE_NOTIFICATION = "com.samvfx7.noor.ACTION_SNOOZE_NOTIFICATION"
